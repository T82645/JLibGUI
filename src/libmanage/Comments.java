...
public class Comments extends JFrame {
	...
	public Comments() {
		...
		lblNewLabel.setBounds(318, 82, 125, 42);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Use the form below to general inquiries, comments that helps our communities.");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblNewLabel_1.setBounds(31, 164, 539, 30);
		...
		textArea.getDocument().addDocumentListener(new DocumentListener() {
			...
			public void insertUpdate(DocumentEvent e) {
				...
				if(e.getDocument().getLength()>300) {
					Object [] op = {"OK"};
					JOptionPane.showOptionDialog(textArea, "Please provide within 300 characters", "INFO", JOptionPane.OK_OPTION, JOptionPane.WARNING_MESSAGE, null, op, op[0]);
				   }else {
		...
		textArea.setBounds(286, 229, 309, 214);
		...
		btnNewButton.setBounds(133, 527, 125, 37);
		...
		chckbxNewCheckBox.setBounds(133, 474, 157, 23);
		...
		btnNewButton_1.setBounds(330, 527, 125, 37);
		...
		lblNewLabel_8.setBounds(220, 34, 303, 37);
